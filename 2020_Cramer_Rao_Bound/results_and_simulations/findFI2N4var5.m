function F = findFI2N4var5(x,gammat,n)
...
rho = ket*ket';
s = spSinglePassXYZ(pi/2,0,gammat,n,1e-6*n,rho,4,1); s.alg = 4;
f = s.getAllFish();
F = -real(f(4)); %INSERT YOUR FUNCTION TO GET F2 HERE, BUT TAKE NEGATIVE VALUE.