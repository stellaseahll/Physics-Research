...
@everywhere include("hoWithBackAction.jl.jl")
...
#save averages
filename = string("Run$(run_)_Ntrials$(Ntrials)_tmax$(tmax)_I$(I_)_g$(g_)_kappa$(kappa_)_gamma$(gamma_)_kT$(kT_)_nH$(nH)_nC$(nC)_k$(k).csv")
