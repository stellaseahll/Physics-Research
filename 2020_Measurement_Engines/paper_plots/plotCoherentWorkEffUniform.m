...
load('CoherentData_Global_wp1_ws100_g2.50_G0.1000_kh0.0010_kc0.1000_nc0.10.mat'); d1 = delta/(g*g/wp)*2; w1 = real(-W)/kh/ws; n1 = real(-W)./real(Qh); 
...
% set(ax,'YTick',0:0.2:0.8);
text(-7.5,0.65,'(a)','interpreter','latex','FontSize',paper.labelSize);
...
text(-7.5,0.82,'(b)','interpreter','latex','FontSize',paper.labelSize);
set(ax,'FontSize',paper.fontSize);
...
print('figCohUniform.pdf', '-dpdf', '-r600')
