...
load('CoherentData_Global_Step_wp1_ws100_g2.50_G0.1000_kh0.0010_kc0.1000_nc1.mat'); d1 = delta/(g*g/wp)*2; w1 = real(-W)/kh/ws; n1 = real(-W)./real(Qh); 
load('CoherentData_Global_wp1_ws100_g2.50_G0.1000_kh0.0010_kc0.1000_nc1.mat'); d2 = delta/(g*g/wp)*2; w2 = real(-W)/kh/ws; n2 = real(-W)./real(Qh); 
% load('CoherentData_Global_Step_wp1_ws100_g2.50_G0.1000_kh0.0010_kc0.1000_nc1.mat'); d3 = delta/(g*g/wp)*2; w1 = real(-W)/kh/ws; n1 = real(-W)./real(Qh); 
% load('CoherentData_Global_wp1_ws100_g2.50_G0.1000_kh0.0010_kc0.1000_nc1.mat'); d4 = delta/(g*g/wp)*2; w2 = real(-W)/kh/ws; n2 = real(-W)./real(Qh); 
...
% set(ax,'YTick',0:0.2:0.8);
text(-7.2,0.45,'(a)','interpreter','latex','FontSize',paper.labelSize);
...
text(-7.2,0.88,'(b)','interpreter','latex','FontSize',paper.labelSize);
set(ax,'FontSize',paper.fontSize);
...
print('figCohNc1Compare.pdf', '-dpdf', '-r600')
