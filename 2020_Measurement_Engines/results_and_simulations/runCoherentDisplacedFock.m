...
for idx1 = 1:length(g)
    ...
    for idx2 = 1:length(nc)
        ...
        W(idx1,idx2) = G*wd*trace(sy*sprhoSS);
...
save('Coherentnofx_nc0.1.mat','nh','nc','kh','kc','g','G','W','Qh','Qc','ws','wp','pop');
% save('CoherentGlobalVarygnc2.mat','nh','nc','kh','kc','g','G','W','Qh','Qc','ws','wp','pop');