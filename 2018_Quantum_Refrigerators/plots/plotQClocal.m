...
c3 = [84 130 53]/255;
c4 = [207 138 68]/255;
load('ohmic_res_local_TC1_TH2_TW8.mat');
maxQC = max(max(QC));
xmax = 1;
ymax = 0.1;
...
k = [0;1];
map = [1 1 1; blue];
map = interp1(k,map,linspace(0,1,20));
map(1,:) = [];
...
contourf(g,kappa,QC,interval,'linecolor','none'); hold on;axis([0 xmax 0 ymax]);
