...
classdef model3SpinsFridgeTwoPhoton < handle
    ...
    methods
        ...
        function obj = model3SpinsFridgeTwoPhoton(G,Ts,ks,Es,Btype,Itype,Mtype,J)
            if nargin>=1
                obj.g = G;
            end
            if nargin>=2
...
%             n3 = nbar(obj,obj.E3,obj.T3); 
            ...
            switch obj.meType
                case 'local'
                    ...
                    obj.LOps{3} = sqrt(obj.k2*2*(n2+1)) * kron( Id, kron(s_m*s_m, Id) );
                    obj.LOps{4} = sqrt(obj.k2*2*n2) * kron( Id, kron(s_p*s_p, Id) );
                ...
                otherwise
                    ...
                    switch obj.bathType
                        case 'cubic'
                            getLindblad(obj,kron(s_p*s_p + s_m*s_m,kron(Id,Id)),obj.k1/(obj.E1)^3,obj.T1);
                            getLindblad(obj,kron(Id,kron(s_p*s_p + s_m*s_m,Id)),obj.k2/(obj.E2)^3,obj.T2);
                            getLindblad(obj,kron(Id,kron(Id,s_p*s_p + s_m*s_m)),obj.k3/(obj.E3)^3,obj.T3);
                        case 'ohmic'

                            getLindblad(obj,kron(s_p*s_p + s_m*s_m,kron(Id,Id)),obj.k1/obj.E1,obj.T1);
                            getLindblad(obj,kron(Id,kron(s_p*s_p + s_m*s_m,Id)),obj.k2/obj.E2,obj.T2);
                            getLindblad(obj,kron(Id,kron(Id,s_p*s_p + s_m*s_m)),obj.k3/obj.E3,obj.T3);
                        case 'flat'
                            getLindblad(obj,kron(s_p*s_p + s_m*s_m,kron(Id,Id)),obj.k1,obj.T1);
                            getLindblad(obj,kron(Id,kron(s_p*s_p + s_m*s_m,Id)),obj.k2,obj.T2);
                            getLindblad(obj,kron(Id,kron(Id,s_p*s_p + s_m*s_m)),obj.k3,obj.T3);
                    end
            end
            %Hamiltonian part
